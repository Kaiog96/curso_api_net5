        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    TermsOfService = new Uri("https://www.linkedin.com/in/kaio-aime-garcia-7733a41a1/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Kaio Aime Garcia",
                        Email = "contatokaiogarcia@mail.com",
                        Url = new Uri("https://www.linkedin.com/in/kaio-aime-garcia-7733a41a1/")
                    },
